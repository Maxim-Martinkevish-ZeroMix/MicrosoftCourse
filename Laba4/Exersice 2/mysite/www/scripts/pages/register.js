...
const checkPasswords = function() {
    let passwordMatch = passwordInput.value === confirmPasswordInput.value;
    if (passwordMatch) {
        confirmPasswordInput.setCustomValidity("");
    } else {
        confirmPasswordInput.setCustomValidity("Your password don't match. Please type your password again.")
    }
};
